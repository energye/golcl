...
func (f *TMainForm) OnPanel2Resize(sender lcl.IObject) {
	w := (f.Panel2.Width() - f.Splitter1.Width()) / 2
	f.MmoInput.SetWidth(w)
	f.MmoOutput.SetWidth(w)
}

func (f *TMainForm) OnMmoInputChange(sender lcl.IObject) {
...
func (f *TMainForm) OnBtnCopyClick(sender lcl.IObject) {
