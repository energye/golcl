...
func (f *TForm1) OnFormShow(object lcl.IObject) {
...
func (f *TForm1) OnLstLeftDrawItem(control lcl.IWinControl, index int32, aRect types.TRect, state types.TOwnerDrawState) {
	r := types.TRect{}
...
func (f *TForm1) OnLstRightDrawItem(control lcl.IWinControl, index int32, aRect types.TRect, state types.TOwnerDrawState) {
