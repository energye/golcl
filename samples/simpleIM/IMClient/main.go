...
import (
	...
	"github.com/energye/golcl/samples/simpleIM"
)

// 我就是测试下随便写的林

var (
	memoMsg, memoSendMsg       *lcl.TMemo
	friendList                 *lcl.TListBox
	btnSend                    *lcl.TButton
	tcpConn                    net.Conn
	nickName                   string
	mainForm, frmNickNameInput *lcl.TForm

	editNickName *lcl.TEdit
)
...
func applicationException(sender lcl.IObject, e *lcl.Exception) {
