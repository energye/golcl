...
func (f *TForm1) OnComboBox1Exit(sender lcl.IObject) {
	f.ComboBox1.Hide()
...
func (f *TForm1) OnEdit1Exit(sender lcl.IObject) {
	f.Edit1.Hide()
	if f.subItemHit.IItem != -1 {
...
func (f *TForm1) OnListView1DblClick(sender lcl.IObject) {
	p := f.ListView1.ScreenToClient(lcl.Mouse.CursorPos())
