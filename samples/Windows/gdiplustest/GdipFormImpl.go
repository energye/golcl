...
func (f *TGdipForm) OnFormCreate(sender lcl.IObject) {
...
func (f *TGdipForm) OnFormDestroy(sender lcl.IObject) {
	if f.btn1.Image != nil {
...
func (f *TGdipForm) OnFormMouseDown(sender lcl.IObject, button types.TMouseButton, shift types.TShiftState, x, y int32) {
...
func (f *TGdipForm) OnFormMouseMove(sender lcl.IObject, shift types.TShiftState, x, y int32) {
...
func (f *TGdipForm) OnFormMouseUp(sender lcl.IObject, button types.TMouseButton, shift types.TShiftState, x, y int32) {
	if button == types.MbLeft {
		if f.btn1.InControl {
			f.btn1.State = 1
		} else {
