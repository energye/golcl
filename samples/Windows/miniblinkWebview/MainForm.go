...
type TMainForm struct {
	*lcl.TForm
	Panel1            *lcl.TPanel
	StatusBar1        *lcl.TStatusBar
	Panel2            *lcl.TPanel
	PnlWeb            *lcl.TPanel
	Panel3            *lcl.TPanel
	BtnBack           *lcl.TButton
	BtnForward        *lcl.TButton
	BtnReload         *lcl.TButton
	Panel4            *lcl.TPanel
	BtnNav            *lcl.TButton
	Panel5            *lcl.TPanel
	Label1            *lcl.TLabel
	EdtURL            *lcl.TEdit
	BtnLoadFromFile   *lcl.TButton
	BtnLoadFromString *lcl.TButton
	OpenDialog1       *lcl.TOpenDialog
	ActionList1       *lcl.TActionList
	ActGoBack         *lcl.TAction
	ActGoForward      *lcl.TAction
	ActNav            *lcl.TAction
	BtnExecJS         *lcl.TButton
