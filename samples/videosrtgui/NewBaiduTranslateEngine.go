...
type TNewBaiduTranslateEngine struct {
	*lcl.TForm
	...
	EdtName       *lcl.TEdit
	EdtAppId      *lcl.TEdit
	EditAppSecret *lcl.TEdit
	CbbType       *lcl.TComboBox
	BtnOK         *lcl.TButton
	Button2       *lcl.TButton
...
func NewNewBaiduTranslateEngine(owner lcl.IComponent) (root *TNewBaiduTranslateEngine) {
...
var _ = lcl.RegisterFormResource(NewBaiduTranslateEngine, &newBaiduTranslateEngineBytes)
