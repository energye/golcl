...
type TNewTencentTranslateEngine struct {
	*lcl.TForm
	...
	Label5        *lcl.TLabel
	EdtName       *lcl.TEdit
	EdtSecretId   *lcl.TEdit
	EditSecretKey *lcl.TEdit
	BtnOK         *lcl.TButton
	Button2       *lcl.TButton
...
func NewNewTencentTranslateEngine(owner lcl.IComponent) (root *TNewTencentTranslateEngine) {
...
var _ = lcl.RegisterFormResource(NewTencentTranslateEngine, &newTencentTranslateEngineBytes)
